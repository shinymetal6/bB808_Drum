...
#ifndef SRC_BB808_QSPI_SAMPLE_MANAGER_OLD_H_
#define SRC_BB808_QSPI_SAMPLE_MANAGER_OLD_H_
...
extern	void QSPI_ReadDescriptorFileFromUSB(void);
extern	void QSPIInstrumentON(uint8_t instrument_number);
extern	void QSPIInstrumentOFF(uint8_t instrument_number);
extern	void QSPI_ReadDescriptorFileFromUSB(void);
extern	uint32_t QSPISamplePlayerStart(void);

#endif /* SRC_BB808_QSPI_SAMPLE_MANAGER_OLD_H_ */
